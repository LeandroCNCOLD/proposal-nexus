  ...
  const thermalSimulationFields = (
    <>
      ...
      <div className="mt-5 grid grid-cols-1 gap-x-10 xl:grid-cols-2"><div>
        ...
        <ColdProField label="Velocidade do ar" helpKey="simulatedAirVelocity" unit="m/s"><ColdProInput {...simNum("air_velocity_m_s")} readOnly={simulation.airflow_source === "airflow_by_fans"} /></ColdProField>
