...
/**
 * Converte um layout em estilos CSS para fundo + borda no editor.
 * Também aceita o legado `background: "white"|"primary"|"muted"|"transparent"`.
 */
export function layoutToBoxStyle(
  ...
  const mode = layout.bgMode ?? (layout.background === "white" || layout.background === "primary" || layout.background === "muted" ? "solid" : "none");
...
/**
 * Resolve o fundo para o PDF (react-pdf não suporta gradientes linear-gradient diretamente,
 * então usamos a cor "from" como aproximação para gradientes).
 */
