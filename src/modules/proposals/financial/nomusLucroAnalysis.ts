import { parseFinancialNumber } from "@/modules/proposals/financial";
...
export function resolveNomusLucroAnalysisValues(input: {
  ...
  const value = (detailKeys: string[], proposalKey: keyof ProposalAnaliseLucro): number | null => {
    if (useDetail && input.analiseLucro) return pickNum(input.analiseLucro, ...detailKeys);
  ...
  return {
    ...
    valorComDesconto: value(["valorTotalComDesconto", "valorComDesconto"], "valor_total_com_desconto"),
    ...
    simples: value(["valorSimplesNacional", "valorSimplesNacionalRecolher"], "simples_nacional_recolher"),
    ...
    outrasDespesas: value(["valorOutrasDespesasAcessorias", "despesasAcessorias", "outrasDespesas"], "despesas_acessorias"),
    ...
    margemBruta: margin(["margemBruta", "margemLucroBruto", "margemBrutaPct", "percentualMargemBruta"], "margem_bruta_pct"),
    ...
    custosIncidentes: value(["custosIncidentesLucro", "custosIncidentesSobreLucro"], "custos_incidentes_lucro"),
    lucroLiquido: value(["lucroLiquido", "valorLucroLiquido"], "lucro_liquido"),
    margemLiquida: margin(["margemLiquida", "margemLucroLiquido", "margemLiquidaPct", "percentualMargemLiquida"], "margem_liquida_pct"),
  };
}
