...
function calculateTunnelCore(input: TunnelEngineInput) {
  ...
  const formulasUsed = {
    ...
    totalKW: "productLoadKW + packagingLoadKW + transmissionLoadKW + infiltrationLoadKW + internalLoadKW + defrostLoadKW",
