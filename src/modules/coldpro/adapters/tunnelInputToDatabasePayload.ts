...
const INPUT_FIELDS = [
  ...
  "block_exposure_factor", "airflow_m3_h", "air_flow_m3_h", "informed_air_flow_m3_h", "air_flow_method", "air_delta_t_k",
...
export function tunnelResultToDatabasePayload(form: any, tunnelResult: any) {
  ...
  const payload = {
    ...
    air_flow_m3_h: round(tunnelResult?.estimatedAirflowM3H ?? tunnelResult?.airFlowM3H, 2),
