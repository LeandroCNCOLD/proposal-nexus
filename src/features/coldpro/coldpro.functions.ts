...
export const upsertColdProEnvironmentProduct = createServerFn({ method: "POST" })
  .inputValidator(z.object({
    id: z.string().uuid().optional(), environment_id: z.string().uuid(), product_id: z.string().uuid().nullable().optional(), product_name: z.string().min(1), mass_kg_day: z.number().default(0), mass_kg_hour: z.number().default(0), inlet_temp_c: z.number().default(0), outlet_temp_c: z.number().default(0), process_time_h: z.number().default(24), packaging_mass_kg_day: z.number().default(0), packaging_specific_heat_kcal_kg_c: z.number().default(0.4), specific_heat_above_kcal_kg_c: z.number().default(0), specific_heat_below_kcal_kg_c: z.number().default(0), latent_heat_kcal_kg: z.number().default(0), initial_freezing_temp_c: z.number().nullable().optional(), respiration_rate_0c_w_kg: z.number().nullable().optional(), respiration_rate_5c_w_kg: z.number().nullable().optional(), respiration_rate_10c_w_kg: z.number().nullable().optional(), respiration_rate_15c_w_kg: z.number().nullable().optional(), respiration_rate_20c_w_kg: z.number().nullable().optional()
  }))
  .handler(async ({ data }) => {
    const supabase = supabaseAdmin;
