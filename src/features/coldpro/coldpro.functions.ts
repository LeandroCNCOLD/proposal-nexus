...
export const getColdProProjectBundle = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    ...
    const enrichedProducts = await enrichRowsWithCatalog(supabase, products ?? []);
    const latestTunnels = await enrichRowsWithCatalog(supabase, latestRowsByEnvironment(tunnels ?? []));
    return { project, environments: environments ?? [], products: enrichedProducts, tunnels: latestTunnels, advancedProcesses: advancedProcesses ?? [], results: latestResults, selections: enrichedSelections, insulationMaterials: insulationMaterials ?? [], thermalMaterials: thermalMaterials ?? [], productCatalog: productCatalog ?? [] };
  });
...
export const upsertColdProTunnel = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .inputValidator(z.object({
    id: z.string().uuid().optional(), environment_id: z.string().uuid(), tunnel_type: z.string().trim().max(80).default("continuous_belt"), operation_mode: z.enum(["continuous", "batch"]).default("continuous"), process_type: z.string().trim().max(80).default("continuous_belt"), arrangement_type: z.string().trim().max(80).default("individual_units"), product_id: z.string().uuid().nullable().optional(), product_name: trimmedName.default("Produto"), product_length_m: nonNegativeNumber.default(0), product_width_m: nonNegativeNumber.default(0), product_thickness_m: nonNegativeNumber.default(0), unit_weight_kg: nonNegativeNumber.default(0), product_thickness_mm: nonNegativeNumber.default(0), product_unit_weight_kg: nonNegativeNumber.default(0), units_per_cycle: nonNegativeNumber.default(0), cycles_per_hour: nonNegativeNumber.default(0), mass_kg_hour: nonNegativeNumber.default(0), pallet_length_m: nonNegativeNumber.default(0), pallet_width_m: nonNegativeNumber.default(0), pallet_height_m: nonNegativeNumber.default(0), pallet_mass_kg: nonNegativeNumber.default(0), number_of_pallets: nonNegativeNumber.default(1), batch_time_h: nonNegativeNumber.default(0), layers_count: nonNegativeNumber.default(0), boxes_count: nonNegativeNumber.default(0), tray_spacing_m: nonNegativeNumber.default(0), package_type: z.string().max(80).nullable().optional(), air_exposure_factor: nonNegativeNumber.nullable().optional(), thermal_penetration_factor: nonNegativeNumber.nullable().optional(), airflow_m3_h: nonNegativeNumber.default(0), physical_model: z.string().trim().max(80).nullable().optional(), spiral_turbulence_factor: nonNegativeNumber.nullable().optional(), block_exposure_factor: nonNegativeNumber.nullable().optional(), air_flow_method: z.string().trim().max(80).nullable().optional(), air_delta_t_k: positiveNumber.default(6), suggested_air_temp_c: finiteNumber.nullable().optional(), suggested_air_method: z.string().trim().max(80).nullable().optional(), suggested_air_approach_k: positiveNumber.nullable().optional(), min_air_temp_c: finiteNumber.default(-40), max_air_temp_c: finiteNumber.default(-25), min_air_velocity_m_s: nonNegativeNumber.default(1), max_air_velocity_m_s: positiveNumber.default(6), air_temp_step_c: positiveNumber.default(5), air_velocity_step_m_s: positiveNumber.default(1), recommended_air_temp_c: finiteNumber.nullable().optional(), recommended_air_velocity_m_s: nonNegativeNumber.nullable().optional(), optimization_status: z.string().trim().max(80).nullable().optional(), optimization_margin_percent: finiteNumber.nullable().optional(), optimization_attempts_count: z.number().int().nonnegative().nullable().optional(), optimization_memory: z.record(z.string(), z.unknown()).nullable().optional(), convective_coefficient_manual_w_m2_k: nonNegativeNumber.nullable().optional(), convective_coefficient_effective_w_m2_k: nonNegativeNumber.nullable().optional(), thermal_characteristic_dimension_m: nonNegativeNumber.nullable().optional(), distance_to_core_m: nonNegativeNumber.nullable().optional(), inlet_temp_c: finiteNumber.default(0), outlet_temp_c: finiteNumber.default(-18), freezing_temp_c: finiteNumber.nullable().optional(), density_kg_m3: nonNegativeNumber.nullable().optional(), thermal_conductivity_frozen_w_m_k: nonNegativeNumber.nullable().optional(), thermal_conductivity_unfrozen_w_m_k: nonNegativeNumber.nullable().optional(), convective_coefficient_w_m2_k: nonNegativeNumber.nullable().optional(), estimated_freezing_time_min: nonNegativeNumber.nullable().optional(), retention_status: z.string().trim().max(80).nullable().optional(), recommended_airflow_m3_h: nonNegativeNumber.nullable().optional(), air_temp_source: z.enum(["environment", "manual"]).default("environment"), air_temp_c: finiteNumber.default(-35), air_velocity_m_s: nonNegativeNumber.default(3), process_time_min: positiveNumber.default(60), specific_heat_above_kj_kg_k: nonNegativeNumber.nullable().optional(), specific_heat_below_kj_kg_k: nonNegativeNumber.nullable().optional(), specific_heat_above_kcal_kg_c: nonNegativeNumber.default(0.8), specific_heat_below_kcal_kg_c: nonNegativeNumber.default(0.4), latent_heat_kj_kg: nonNegativeNumber.nullable().optional(), latent_heat_kcal_kg: nonNegativeNumber.default(60), water_content_percent: nonNegativeNumber.nullable().optional(), protein_content_percent: nonNegativeNumber.nullable().optional(), fat_content_percent: nonNegativeNumber.nullable().optional(), carbohydrate_content_percent: nonNegativeNumber.nullable().optional(), fiber_content_percent: nonNegativeNumber.nullable().optional(), ash_content_percent: nonNegativeNumber.nullable().optional(), frozen_water_fraction: nonNegativeNumber.nullable().optional(), freezable_water_content_percent: nonNegativeNumber.nullable().optional(), respiration_rate_0c_mw_kg: nonNegativeNumber.nullable().optional(), respiration_rate_5c_mw_kg: nonNegativeNumber.nullable().optional(), respiration_rate_10c_mw_kg: nonNegativeNumber.nullable().optional(), respiration_rate_15c_mw_kg: nonNegativeNumber.nullable().optional(), respiration_rate_20c_mw_kg: nonNegativeNumber.nullable().optional(), notes: z.string().max(1000).nullable().optional(), packaging_mass_kg_hour: nonNegativeNumber.default(0), packaging_specific_heat_kcal_kg_c: nonNegativeNumber.default(0.4), continuous_mass_mode: z.string().trim().max(80).nullable().optional(), mass_flow_mode: z.string().trim().max(80).nullable().optional(), units_per_hour: nonNegativeNumber.nullable().optional(), units_per_row: nonNegativeNumber.nullable().optional(), rows_per_meter: nonNegativeNumber.nullable().optional(), belt_speed_m_min: nonNegativeNumber.nullable().optional(), feed_rate_kg_h: nonNegativeNumber.nullable().optional(), trays_per_hour: nonNegativeNumber.nullable().optional(), tray_weight_kg: nonNegativeNumber.nullable().optional(), belt_motor_kw: nonNegativeNumber.default(0), belt_width_m: nonNegativeNumber.nullable().optional(), belt_effective_length_m: nonNegativeNumber.nullable().optional(), belt_area_m2: nonNegativeNumber.nullable().optional(), belt_surface_density_kg_m2: nonNegativeNumber.nullable().optional(), belt_mass_on_belt_kg: nonNegativeNumber.nullable().optional(), belt_linear_load_kg_m: nonNegativeNumber.nullable().optional(), belt_flow_by_retention_kg_h: nonNegativeNumber.nullable().optional(), belt_flow_by_speed_kg_h: nonNegativeNumber.nullable().optional(), belt_calculated_flow_kg_h: nonNegativeNumber.nullable().optional(), belt_nominal_capacity_kg_h: nonNegativeNumber.nullable().optional(), belt_calculated_retention_min: nonNegativeNumber.nullable().optional(), belt_capacity_deviation_percent: finiteNumber.nullable().optional(), belt_motor_inside_environment: z.boolean().default(true), belt_motor_dissipation_factor: nonNegativeNumber.default(1), internal_fans_kw: nonNegativeNumber.default(0), other_internal_kw: nonNegativeNumber.default(0), calculated_mass_kg_h: nonNegativeNumber.nullable().optional(), used_mass_kg_h: nonNegativeNumber.nullable().optional(), tunnel_product_load_kw: nonNegativeNumber.nullable().optional(), tunnel_packaging_load_kw: nonNegativeNumber.nullable().optional(), tunnel_internal_load_kw: nonNegativeNumber.nullable().optional(), tunnel_total_load_kw: nonNegativeNumber.nullable().optional(), tunnel_total_load_kcal_h: nonNegativeNumber.nullable().optional(), tunnel_total_load_tr: nonNegativeNumber.nullable().optional(), process_status: z.string().trim().max(80).nullable().optional(), informed_air_flow_m3_h: nonNegativeNumber.nullable().optional(), approved_air_temp_c: finiteNumber.nullable().optional(), approved_air_velocity_m_s: nonNegativeNumber.nullable().optional(), approved_air_delta_t_k: positiveNumber.nullable().optional(), approved_air_flow_m3_h: nonNegativeNumber.nullable().optional(), approved_convective_coefficient_w_m2_k: nonNegativeNumber.nullable().optional(), approved_packaging_type: z.string().max(80).nullable().optional(), approved_air_exposure_factor: nonNegativeNumber.nullable().optional(), approved_thermal_penetration_factor: nonNegativeNumber.nullable().optional(), approved_process_status: z.string().trim().max(80).nullable().optional(), approved_estimated_time_min: nonNegativeNumber.nullable().optional(), approved_total_kw: nonNegativeNumber.nullable().optional(), approved_total_kcal_h: nonNegativeNumber.nullable().optional(), approved_total_tr: nonNegativeNumber.nullable().optional(), thermal_condition_approved: z.boolean().default(false), thermal_condition_approved_at: z.string().datetime().nullable().optional(), product_geometry: z.string().trim().max(80).nullable().optional(), surface_exposure_model: z.string().trim().max(80).nullable().optional(), airflow_source: z.string().trim().max(80).default("manual_velocity"), fan_airflow_m3_h: nonNegativeNumber.nullable().optional(), tunnel_cross_section_width_m: nonNegativeNumber.nullable().optional(), tunnel_cross_section_height_m: nonNegativeNumber.nullable().optional(), blockage_factor: nonNegativeNumber.default(0), calculated_air_velocity_m_s: nonNegativeNumber.nullable().optional(), air_velocity_used_m_s: nonNegativeNumber.nullable().optional(), gross_air_area_m2: nonNegativeNumber.nullable().optional(), free_air_area_m2: nonNegativeNumber.nullable().optional(), product_height_m: nonNegativeNumber.nullable().optional(), product_side_m: nonNegativeNumber.nullable().optional(), product_diameter_m: nonNegativeNumber.nullable().optional(), equivalent_diameter_m: nonNegativeNumber.nullable().optional(), characteristic_dimension_m: nonNegativeNumber.nullable().optional(), box_length_m: nonNegativeNumber.nullable().optional(), box_width_m: nonNegativeNumber.nullable().optional(), box_height_m: nonNegativeNumber.nullable().optional(), bulk_layer_height_m: nonNegativeNumber.nullable().optional(), equivalent_particle_diameter_m: nonNegativeNumber.nullable().optional(), calculation_warnings: z.array(z.string()).default([]), missing_fields: z.array(z.string()).default([]), calculation_breakdown: z.record(z.string(), z.unknown()).default({}), calculation_log: z.record(z.string(), z.unknown()).default({})
  }))
  .handler(async ({ data }) => {
    const supabase = supabaseAdmin;
