...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  comp_power: ["potencia eletrica requerida compressor", "potencia compressor", "potencia do compressor"],
  fan_power: ["potencia eletrica requerida ventilador", "potencia ventilador", "potencia ventiladores"],
  total_power: ["potencia eletrica requerida total [circuito completo]", "potencia eletrica requerida total", "potencia total"],
  cop: ["cop"],
  cop_carnot: ["cop carnot"],
  global_cop: ["cop global"],

  voltage: ["tensao eletrica", "tensao", "voltagem", "voltage"],
  comp_current: ["corrente eletrica compressor", "corrente compressor", "corrente do compressor"],
  fan_current: ["corrente eletrica ventiladores", "corrente eletrica ventilador", "corrente ventilador"],
  est_current: ["corrente eletrica estimada [circuito completo]", "corrente eletrica estimada", "corrente estimada", "corrente total estimada"],
  start_current: ["corrente eletrica de partida [circuito completo]", "corrente eletrica de partida", "corrente de partida", "corrente partida"],
