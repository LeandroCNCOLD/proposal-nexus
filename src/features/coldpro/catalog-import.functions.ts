    ...
    await supabase.from("coldpro_equipment_condensers").upsert(
      {
        ...
        tube_outer_diameter_mm: head.condenser.tube_outer_mm,
        tube_inner_diameter_mm: head.condenser.tube_inner_mm,
        tube_thickness_mm: head.condenser.tube_thickness,
        tube_wall_thickness_mm: head.condenser.tube_thickness,
        tube_length_m: head.condenser.tube_length_m,
        tube_count: head.condenser.tube_count,
        ...
        air_throw_m: head.condenser.air_throw,
      },
      { onConflict: "equipment_model_id" }
    );
    ...
    await supabase.from("coldpro_equipment_evaporators").upsert(
      {
        ...
        tube_outer_diameter_mm: head.evaporator.tube_outer_mm,
        tube_inner_diameter_mm: head.evaporator.tube_inner_mm,
        tube_thickness_mm: head.evaporator.tube_thickness,
        tube_wall_thickness_mm: head.evaporator.tube_thickness,
        tube_length_m: head.evaporator.tube_length_m,
        tube_count: head.evaporator.tube_count,
        ...
        air_throw_m: head.evaporator.air_throw,
      },
      { onConflict: "equipment_model_id" }
    );
