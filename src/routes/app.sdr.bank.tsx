        ...
        <td className="px-3 py-2 text-xs min-w-[260px]">
          ...
          {tab === 'arquivados' ? (
            ...
            <div className="flex flex-wrap items-center justify-end gap-1">
              ...
              {isManager && isFrozen && (
                <Button size="sm" variant="outline" className="h-6 px-2 text-[11px]" onClick={() => unlockMut.mutate(r.id)}>
                        ...
                        <div className="flex flex-col items-start gap-2">
                          ...
                          {showGroupActions && (
                            hasReturnable ? (
                              ...
                              <Button
                                size="sm"
                                className="h-6 px-2 text-[11px] bg-blue-600 hover:bg-blue-700 text-white"
